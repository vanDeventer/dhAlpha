...
public class get_temp extends ConcurrentCoapResource{

	private static final Logger LOG = Logger.getLogger(get_temp.class.getName());
	public get_temp() 
	{
		super(RESOURCE_GET_TEMP_NAME);
		getAttributes().setTitle(RESOURCE_GET_TEMP_TITLE);
	}
	public get_temp(String name, int threads) {
		super(name, threads);
	}
